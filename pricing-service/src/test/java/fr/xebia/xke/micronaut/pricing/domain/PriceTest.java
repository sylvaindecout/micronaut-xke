...
import static fr.xebia.xke.micronaut.pricing.domain.Price.cents;
...
class PriceTest {
    ...
    @Property
    void should_apply_no_discount(@ForAll Price price) {
        assertThat(price.apply(noDiscount())).isEqualTo(price);
    }

    @Property
    void should_fail_to_apply_null_discount(@ForAll Price price) {
        assertThatNullPointerException()
                .isThrownBy(() -> assertThat(price.apply(null)));
    }
